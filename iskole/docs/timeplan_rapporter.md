...
I skjermbildet ovenfor har vi valgt _Forhåndsvisning_ av gruppefag registrert under ST1. Ved å klikke på tallet 24 får vi navnet på de 24 elevene som har har valgt ST1:MAP 3. Vi ser at blant disse 24 har 8 også har valgt ST1:TY2 1. Klikker vi deretter på tallet 8, får vi kun frem de 8 elevene som også har valgt ST1:MAP 1. (At ST1:TY2 1 har 26 elever ser vi nederst til høyre.)
