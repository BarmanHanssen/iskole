...
## Klassefag
Klassene, og fagene til hver klasse, er registrert fra _Grunnlagsdata>Fag_ og _Grunnlagsdata>Klasser_. Eventuell endring av klasser og fag kan ikke gjøres her.
