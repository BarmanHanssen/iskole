...
Klassens timeplan vises i høyre del av skjermen. Klassefagene vises på blå bakgrunn, og ledige timer for klassefag på grønn bakgrunn.

I tillegg til  _Klasse_ og _Timeplan klasse_ plasseres _Vis timeplan for disse ansatte_ og _Timeplan lærer_ på nedre del av skjermen. 

Etter først å ha valgt klasse og uke velges nå et fag for timeplanlegging, eller for endring av fagets timeplan. Uansett grunn, idet vi velger fag vil klassens timeplan bli mer detaljert såfremt elevene har valgt gruppefag, og disse alt er timeplanlagt.

Dersom vi klikker på faglæreren i ENG fås dette skjermbildet:
...
Dersom et fag har _Gjester_, dvs at elevene fra klassen _Gjester_ også ha faget på sin timeplan, anbefales å legge disse fagene først. Disse timene vil begrense gjesteklassens valgmuligheter på sin timeplan. Og tilsvarende: Dersom gjesteklassen alt er timeplanlagt, vil dette begrense timeplanleggers valgmuligheter.
...
Lærer(e) i det valgte faget legges automatisk inn her. Timeplanen for alle fag til læreren(e) som alt er timeplanlagt vises i skjermbildet _Timeplan lærer_ på samme bakgrunnsfarge.
Timeplanlegger kan legge til en eller flere andre lærere fra nedtrekkslisten _Legg til lærer_.

#### Timeplan lærer
Her vises timeplanen til lærer(e) som står oppført under _Vis timeplanen for disse ansatte_.
...
Dersom man har gjort en endring på en allerede lagt klassetimeplan, og endringen skal gjelde frem i tid, kan man kopiere denne ukes timeplan frem i tid. Dersom endringen ikke medfører kollisjoner i valgte uker fremover, vil den nye klassetimeplanen gjelde for alle valgte uker.


:::tip Tips
Når alle klassefag og gruppefag er timeplanlagt, eksempelvis for første skoleuke, kan man kopiere timeplanen for klasse- og gruppefag samlet, se menyvalget _Kopiering_. Det er fullt mulig å kopiere bare en enkelt klassens timeplan (eller et gruppefag). Det er selvsagt mer krevende, da kontroller må utføres mot alle allerede lagte timeplaner for klasser og grupper. Kopieringen blir ikke gjennomført dersom kollisjoner blir avdekket.
:::
