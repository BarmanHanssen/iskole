...
- Det er mulig å legge til fag direkte herfra (se Legg til). Forutsetningen er at faget er tilgjengelig (Se på klassen fra Grunnlagsdata>Fag_, klikk på _Endre_).
