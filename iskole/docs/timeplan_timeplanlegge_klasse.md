...
Skjermen for timeplanlegger er inndelt i fire separate deler (Timeplan klasse, Timeplan lærer) som beskriver forskjellige deler av datasettet en timeplanlegger må forholde seg til. Sluttresultatet blir timeplanen for en angitt klasse (her ST1A) i en valgt uke (her 2020-09).
