...
For å kunne registrere en sensor må denne først registreres som ansatt ved skolen. Ved å trykke på knappen «Legg til...» får man frem alle ansatte ved skolen som ikke allerede er registrert som sensor. Man kan også velge blant ansatte som har sluttet - kryss da av for «Vis sluttede» over listen av potensielle sensorer. 
...
Man sletter et fag fra en sensor ved å trykke på ikonet for sletting. Faget slettes da umiddelbart såfremt ikke sensoren er registrert med fremtidige sensoroppdrag i faget.
