...
- _Dokumentasjonstype_: Vitnemål gjelder som regel for fagene i avgangsklassene. (Flere muligheter på elevnivå, eksempelvis komprtansebevis eller karakterustskrift.)
