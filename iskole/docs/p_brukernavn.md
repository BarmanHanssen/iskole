...
1. Fødselsnummeret (11 siffer).
2. Brukernavn som kan genereres herfra.
3. epost-adressen som er lagret i iSkole.

Fødselsnummer kan alltid benyttes.
Brukernavn generert herfra må være entydig for alle som er registrert i iSkole. Dersom et foreslått brukernavn alt er i bruk, blir det avvist.
epost-adressen kan bare benyttes dersom den bare er knyttet til en person. Dersom eksempelvis foreldre og barn (altså elev) er registrert med lik epost, kan epost-adressen ikke benyttes for innlogging.
...
De tre første bokstavene fra henholdsvis for- og etternavn foreslås. Dersom kombinasjonen ikke godkjennes er det fordi en person allerede er tildelt dette brukernavnet. Da kan en huke av for å tilføye årstall og/eller dato, alternativt endre antall bokstaver, for å finne en unik kombinasjon.
