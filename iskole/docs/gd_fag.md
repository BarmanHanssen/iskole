...
:::
## Generelt
Fagene som kan tilordnes en klasse (se menyvalget _Klasser_) må være registrert her som klassefag. Dersom elevene kan velge noen fag i tillegg til klassefagene (se menyvalget _Grupper_), må også slike fag regitreres her Gruppefag.
...
Denne todelingen av fag (klassefag og gruppefag)  gjør det mulig å timeplanlegge fagene slik at hver elev , uke for uke hele skoleåret, skal få en korrekt timeplan. Og tilsvarende for alle lærere.
