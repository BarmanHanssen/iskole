...
- Kontaktperson for iSkole er vanligvis den som har best kjennskap til iSkoles virkemåte og derfor er den som kan gi råd og veiledning. Vedkommende er også den som kan henvende seg til leverandøren angående feil/mangler og ønsker vedrørende bruk av iSkole. Viktigste kanal er support@barman-hanssen.no
...
- Eksamensansvarlig har med oppsett av såvel muntlige som skriftlige eksamenspartier.
- PASansvarlig har ansvaret for at oppsatte eksamenspartier blir overført til PAS.

## Funksjoner
Her vises oversikt over tilleggsfunksjoner/moduler tilknyttet iSkole, og om tilvalget medfører ekstra kostnader. Når det avhukes for en tilleggsfunksjon, eksempelvis for internat, vil _Internat_ tilføyes som arkfane på _mine sider_, og  denne programvaren blir da tilgjengelig.
...
_Ansatt_: For å kunne få tilgang til denne modulen av iSkole må personen være registrert fra _Personal>Ansatt_. Tilgangen er tidsbegrenset til datoene gitt mellom _Begynte_ og _Sluttet_.
...
## Karakterer
Rektor/administrator fastsetter tidsintervallet hvor faglærerne skal innføre termin- og standpunktkarakterer, og når elevene gis innsyn til sine resultater.
...
Skolen kan åpne for at årets elever på vg1 og vg2 som skal fortsette skolegangen neste skoleår kan få velge neste års valgfag allerede inneværende skoleår (typisk i januar/februar). 
Her registreres tidsrommet elevene kan gjøre sine valg, altså fra og med dato og frem til og med siste dag.
...
#### Stenging av iSkole
Stengingen, og åpning, foretas av rektor eller administrator. Ved forsøk på å logge inn, vil det gis beskjed om at iSkole er stengt. I tidsrommet hvor iSkole er stengt, er det bare rektor og administrator som kan logge seg på.

#### Tilgang til Mine sider i skoleåret
I starten (og gjerne før start) av skoleåret er det ofte ønskelig at timeplanleggeren får legge timeplanen ferdig før den vises, og at neste års elever ikke får innsyn i hvilken klasse og lærere som de skal forholde seg til. 

_Timeplanen er synlig i hele planperioden for de ansatte_

Det kan være greit for timeplanlegger å få arbeide uforstyrret til timeplanen er ferdiglagt. For å skjerme timeplanlegger kan en her sette en dato senere enn 1. august. De ansatte får da ikke tilgang til iSkole før denne datoen.

_iSkole er synlig for elevene fra_

Elevene har i utgangspunktet tilgang til iSkole hele skoleåret hvor de er registrert som elev, altså helt frem til til skoleårets slutt som i utgangspunktet er 31. juli. Dersom eleven slutter før skoleårets slutt, mistes tilgangen. Dersom en ønsker at elevene  ikke får tilgang til neste skoleår fra 1. august kan en sette inn en senere dato her.
...
Klikk _Legg til_ for å opprette en ny redaktør. Merk at også en elev kan få redaktørstatus (feks elevrådsleder). 
