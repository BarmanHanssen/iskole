...
:::note Merk 
Ressursfordelingen for faget ( se _Grunnlagsdata>Fag_) gis til faglæreren som står oppført på første linje. Skal ressursen fordeles, må det korrigeres fra _Andre ressurser_. 
:::
### # (gruppenr)
