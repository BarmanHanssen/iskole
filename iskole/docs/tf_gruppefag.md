...
:::note Merk 
Fagets ressurs (se _Grunnlagsdata>Fag_) gis til faglæreren som står oppført på første linje i oversikten over fagene. Skal ressursen fordeles, må det korrigeres fra _Andre ressurser_. 
:::
### # (gruppenr)
