module.exports = {
  someSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Grunnlagsdata',
      items: ['gd_skole','gd_rom','gd_planperiode','gd_skolerute','gd_utdanningsprogram','gd_fag','gd_klasse','gd_grupper','gd_fagklasse'
    ...
    },
    {
      ...
      items: ['timeplan_time','timeplan_reserver','timeplan_definer_blokknr','timeplan_blokknr_gruppefag'
          ,'timeplan_timeplanlegge_klasse','timeplan_timeplanlegge_tolaerer','timeplan_kopiering','timeplan_rapporter'],
    },
    {
      type: 'category',
      label: 'Elevadmin',
